...
Xmcd to pakiet do odtwarzania płyt CD o dużych możliwościach
zawierający xmcd - program dla X11 i cda - program działający w trybie
tekstowym. Cda może działać w trybie pełnoekranowym jak i być
sterowany z linii poleceń. Obydwa te programy pozwalają przekształcić
Twój napęd CD-ROM, CD-R bądź CD-RW w stereofoniczny odtwarzacz płyt
kompaktowych.
